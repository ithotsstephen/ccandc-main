...
const INTEGRATION_TRAINING_PDF_URL =
  "/assets/pdf_downloads/BIAN Foundation Certification Training (Trainer-Led).pdf";
const INTEGRATION_TRAINING_FORMSPREE = "https://formspree.io/f/mwvzgopl";
...
export default function BianIntegrationTraining() {
  useEffect(() => {
    window.scrollTo(0, 0);
    ...
    if (metaDescription) {
      metaDescription.setAttribute(
        "content",
        "BIAN Integration training covering BIAN core principles, service domains, business scenarios, and exam preparation through interactive in-person or virtual delivery.",
      );
    }

    const ogTitle = document.querySelector('meta[property="og:title"]');
    if (ogTitle) {
      ogTitle.setAttribute("content", "BIAN Integration Training | CC&C Solutions");
    }
    ...
    if (ogDescription) {
      ogDescription.setAttribute(
        "content",
        "Build practical BIAN integration knowledge with expert-led training for banking architecture professionals.",
      );
    }

    document.title = "BIAN Integration Training | CC&C Solutions";
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              The BIAN Integration training program is designed to provide participants with a thorough understanding of the BIAN framework, including its core principles, concepts, and content.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              The training lays the groundwork for more advanced learning and ensures that all participants develop a solid grasp of the essential elements of the BIAN framework, banking product development, service domains, and business scenarios.
            </p>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-12 text-center">
            BIAN Integration Exam Format & Requirements
          </h2>
          <div className="max-w-4xl mx-auto">
            <Card className="premium-card">
              <CardContent className="p-8">
      ...
      <PdfDownloadForm
        sectionTitle="Download BIAN Integration Training Brochure"
        resourceTitle="BIAN Integration Training"
        pdfUrl={INTEGRATION_TRAINING_PDF_URL}
        pdfFileName="BIAN Foundation Certification Training (Trainer-Led).pdf"
        formspreeEndpoint={INTEGRATION_TRAINING_FORMSPREE}
      />

      <section className="py-20 section-darker">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <CTASection
            title="Ready to Start BIAN Integration Training?"
            description="Talk to CC&C Solutions about enrolling your team in interactive BIAN Integration training with exam preparation included."
